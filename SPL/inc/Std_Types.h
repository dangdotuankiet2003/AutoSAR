...
/* @brief: Số lượng nhóm kênh tối đa
 * @details: Định nghĩa số nhóm kênh tối đa hỗ trợ (16 nhóm trong STM32F10x)
 */
#define ADC_GROUP_MAX 16
...
/* @type: Std_ReturnType
 * @brief: Kiểu trả về chuẩn cho API AUTOSAR
 * @details: Biểu diễn kết quả thực hiện API 
 */
typedef enum {
    E_OK    ,
    E_NOT_OK 
